...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, and README at v1.4.34", () => {
    ...
    expect(mcp.match(/version: "1\.4\.34"/gu)).toHaveLength(3);
    expect(readme).toContain("The `1.4.34` packaging configuration produces:");
