...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, and README at v1.4.11", () => {
    ...
    expect(mcp.match(/version: "1\.4\.11"/gu)).toHaveLength(3);
    expect(readme).toContain("The `1.4.11` packaging configuration produces:");
