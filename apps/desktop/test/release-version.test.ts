...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, and README at v1.4.16", () => {
    ...
    expect(readme).toContain("The `1.4.16` packaging configuration produces:");
