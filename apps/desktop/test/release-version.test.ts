...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, and README at v1.4.6", () => {
    ...
    expect(mcp.match(/version: "1\.4\.6"/gu)).toHaveLength(3);
    expect(readme).toContain("The `1.4.6` packaging configuration produces:");
