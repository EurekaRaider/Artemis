...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, theme, and README at v1.4.53", () => {
    ...
    expect(readme).toContain("The `1.4.53` packaging configuration produces:");
