...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, and README at v1.3.29", () => {
    ...
    expect(mcp.match(/version: "1\.3\.29"/gu)).toHaveLength(3);
    expect(readme).toContain("The `1.3.29` packaging configuration produces:");
