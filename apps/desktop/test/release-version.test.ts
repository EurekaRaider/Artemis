...
describe("release version", () => {
  it("keeps manifests, lockfile, MCP identity, and README at v1.4.22", () => {
    ...
    expect(mcp.match(/version: "1\.4\.22"/gu)).toHaveLength(3);
    expect(readme).toContain("The `1.4.22` packaging configuration produces:");
