...
describe("DiagnosticBundleService", () => {
  ...
  it("persists a bounded event buffer and exports only redacted data", async () => {
    ...
    service.recordTurnLatency({
      ...
      cacheKeyFingerprint: "0123456789abcdef-extra-private-data",
      systemPromptFingerprint: "fedcba9876543210-extra",
      toolSchemaFingerprint: "0011223344556677-extra",
      stablePrefixTokens: 1_500,
