...
describe("default and synthetic stress skin conformance", () => {
  ...
  it("renders all 77 computed formal CSS tokens at every Gallery vertex", async () => {
    ...
    expect(Object.keys(SEMANTIC_TOKEN_REGISTRY)).toHaveLength(77);
    ...
    for (const mode of galleryVertices) {
      ...
      await waitFor(() => {
        ...
        expect(outputs).toHaveLength(77);
