...
Status: MIG3B Review/Diff/Environment/Goal/Sources PR #143 implementation
revision is pending the same independent Reviewer recheck on merged MIG3A base
`6fa4887c8850f3d7e21af87bf6b9b705a6b18e6e`; MIG3A is merged. This ledger
...
Reviewer must still approve this revision before the version/README-only head.
...
| Review, Diff, Environment, Goal, Sources                                  | surface            | `@artemis/ui` + Desktop   | users                             | review/environment/source selectors              | MIG3B     | State, permission and overlay geometry matrix                | PR #143 revision pending Reviewer recheck |
