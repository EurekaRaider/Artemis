...
`v1.4.46`. After verification succeeds, native GitHub-hosted runners build
...
The `1.4.46` packaging configuration produces:

| Target                    | Artifacts                                                        |
| ------------------------- | ---------------------------------------------------------------- |
| Windows x64               | `apps/desktop/release/Artemis-Windows-x64-1.4.46.zip`            |
| macOS Apple Silicon arm64 | `apps/desktop/release/Artemis-macOS-arm64-1.4.46.dmg` and `.zip` |
| macOS Intel x64           | `apps/desktop/release/Artemis-macOS-x64-1.4.46.dmg` and `.zip`   |
