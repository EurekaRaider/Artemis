...
Every file you create for the user must be linked at least once in your final response. Use a Markdown link whose destination is relative to the active workspace, for example [report.md](reports/report.md). Wrap destinations containing spaces in angle brackets. Do not use file:// URLs. You may append :line or :line:column when pointing to a specific location in a text file.`;
