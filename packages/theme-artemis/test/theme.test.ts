...
const LIGHT_NORMAL = Object.freeze({
  ...
  "color.terminal.foreground": "#1f2023",
...
const DARK_NORMAL = Object.freeze({
  "color.canvas": "#1d1d1f",
  "color.background.sidebar": "#2c2c2e",
  "color.background.activity": "#3a3a3c",
  "color.surface.base": "#232325",
  "color.surface.raised": "#232325",
  "color.surface.sunken": "#2c2c2e",
  "color.surface.composer": "#232325",
  "color.surface.user": "#3a3a3c",
  "color.interaction.hover": "#f5f5f70d",
  "color.interaction.selected": "#f5f5f714",
  "color.text.primary": "#f5f5f7",
  "color.text.secondary": "#bcbcc1",
  "color.text.tertiary": "#a6a6aa",
  "color.text.inverse": "#1d1d1f",
  "color.border.default": "#ffffff5c",
  "color.border.surface": "#ffffff29",
