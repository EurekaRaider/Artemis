...
export const ARTEMIS_THEME_VERSION = "1.4.62" as const;
...
const lightColors = {
  ...
  "color.background.sidebar": color("#f5f5f7"),
  "color.background.activity": color("#ececee"),
  ...
  "color.surface.user": color("#ececee"),
  "color.interaction.hover": color("#1d1d1f0d"),
  "color.interaction.selected": color("#1d1d1f14"),
  ...
  "color.border.surface": color("#0000001f"),
  ...
  "color.terminal.background": color("#ffffff"),
  "color.terminal.foreground": color("#1f2023"),
...
const darkColors = {
  ...
  "color.background.sidebar": color("#2c2c2e"),
  "color.background.activity": color("#3a3a3c"),
  "color.surface.base": color("#232325"),
  "color.surface.raised": color("#232325"),
  "color.surface.sunken": color("#2c2c2e"),
  "color.surface.composer": color("#232325"),
  "color.surface.user": color("#3a3a3c"),
  "color.interaction.hover": color("#f5f5f70d"),
  "color.interaction.selected": color("#f5f5f714"),
  ...
  "color.border.surface": color("#ffffff29"),
